...
declare namespace egret {
    ...
    interface HttpRequest extends EventDispatcher {
         ...
         * @param method The HTTP method to use, please use the consts value in the HttpMethod class.
         * @see egret.HttpMethod
         * @version Egret 2.4
         * @platform Web,Native
         * @language en_US
...
declare namespace egret {
     ...
     * Note:If you use the TypeScript programming language, the egret command line tools will automatically generate the registration code line.
